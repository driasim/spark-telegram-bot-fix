...
Access level is permission; runner capability is what this exact process can do right now. If Level 4 or 5 is allowed but the runner is read-only, say "allowed, blocked here" and direct the user to "spark access setup", "spark restart", or a writable Spawner/Codex route rather than claiming full access.
