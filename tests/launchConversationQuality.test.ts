...
test('launch natural work replies pass the readability ergonomics vibe bar', () => {
  ...
  assert.match(heartbeat, /^still shaping Paragraph Spacing Smoke Page\. I will send the canvas when it is ready\./m);
  assert.match(stillRunning, /^still preparing Paragraph Spacing Smoke Page\. I will send the canvas when it is ready\./m);
